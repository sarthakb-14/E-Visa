<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddHR.aspx.cs" Inherits="WebApplication4.AddHR" %>
    ...
    <form id="form1" runat="server">
        <div class="container">
            <div class="form-container">
                <h2 class="text-center mb-4">Add HR</h2>

                <div class="form-group">
                    <label for="txtHRName">HR Name</label>
                    <asp:TextBox ID="txtHRName" runat="server" CssClass="form-control" Placeholder="Enter HR Name" />
                </div>

                <div class="form-group">
                    <label for="txtHREmail">HR Email</label>
                    <asp:TextBox ID="txtHREmail" runat="server" CssClass="form-control" Placeholder="Enter HR Email" />
                </div>

                <div class="form-group">
                    <label for="txtHRPassword">HR Password</label>
                    <asp:TextBox ID="txtHRPassword" runat="server" CssClass="form-control" TextMode="Password" Placeholder="Enter HR Password" />
                </div>

                <div class="form-group">
                    <label for="txtHRNumber">HR Number</label>
                    <asp:TextBox ID="txtHRNumber" runat="server" CssClass="form-control" Placeholder="Enter HR Number" />
                </div>
