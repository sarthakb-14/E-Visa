<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ManageHR.aspx.cs" Inherits="WebApplication4.ManageHR" %>
...
<body>
    <form id="form1" runat="server">
        <div class="container">
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">Manage HR</h5>
                    <div class="form-group">
                        <label for="txtHRUsername">HR Username</label>
                        <asp:TextBox ID="txtHRUsername" runat="server" CssClass="form-control" placeholder="Enter HR username" />
                    </div>
